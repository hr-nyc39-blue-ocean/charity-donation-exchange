...
LOAD DATA LOCAL INFILE '/Users/jhwang/Downloads/UsersData.csv' -- change to your local path
INTO TABLE Users
...
LOAD DATA LOCAL INFILE '/Users/jhwang/Downloads/ListingsData.csv' -- change to your local path
INTO TABLE Listings
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
